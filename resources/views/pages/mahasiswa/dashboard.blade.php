...
<div class="helpdesk container">
    <nav class="navbar navbar-expand navbar-light">
        <a class="navbar-brand" href="#">BEASISWA PHB</a>
        ...
        <div class="hd-header-wrapper">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1>
                        <a class="text-white">POLITEKNIK</a>
                        <a class="text-white">HARAPAN BERSAMA TEGAL</a>
                    </h1>
...
{{--                            </div>--}}
                            <div class="field-wrapper mt-3">
                                <button href="#" class="btn btn-light-danger px-5 p-3 text-primary">DETAIL DATA</button>
                            </div>
                        </div>
                    </div>
                </div>
