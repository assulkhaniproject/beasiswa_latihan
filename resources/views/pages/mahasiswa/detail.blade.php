                    ...
                    <form method="post" action="{{route('mahasiswas.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-4 col-lg-9 col-sm-10">
                                <input name="kategori" value="{{$kategori ? $kategori->kategori : ''}}" readonly
                                       type="text" class="form-control" id="kategori" placeholder="" required>
                            </div>
                            <div class="col-xl-2 col-lg-9 col-sm-8">
                                <input name="tahun_akademik" value="{{$kategori ? $kategori->tahun_akademik : ''}}"
                                       readonly type="text" class="form-control" id="tahun_akademik" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="nim" value="{{$user->nim}}" readonly type="text" class="form-control"
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Nama
                                Mahasiswa</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="nama" value="{{$user->nama}}" readonly type="text" class="form-control"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <select name="agama" class="form-control basic" required>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="kode_pos" value="" type="number" maxlength="5" class="form-control"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="semester" value="" type="text" class="form-control" id="semester"
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">No. Hp
                                Mahasiswa</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="no_hp" value="" type="number" maxlength="13"
                                       class="form-control placement-bottom" id="no_hp" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Foto
                                Mahasiswa</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="foto" value="" type="file" class="form-control" accept="image/*" required>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Nama Orang
                                Tua</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="nama_ortu" value="" type="text" class="form-control" id="nama_ortu"
                                       placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="pekerjaan_ortu" value="" type="text" class="form-control"
                                       id="pekerjaan_ortu" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">No. Hp
                                Orangtua</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="no_hp_ortu" value="" type="number" class="form-control" maxlength="13"
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Penghasilan
                                Orangtua</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="penghasilan_ortu" value="" type="number" class="form-control"
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Scan Slip
                                Gaji</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="scan_penghasilan" value="" type="file" class="form-control"
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Jumlah
                                Tanggungan</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="tanggungan_ortu" type="number" class="form-control" id="tanggungan_ortu"
                                       placeholder="" required>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="nama_bank" value="" type="text" class="form-control" id="nama_bank"
                                       placeholder="" required>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="cabang_bank" value="" type="text" class="form-control" id="cabang_bank"
                                       placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">Nama Pemegang
                                Rekening</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="nama_rek" value="" type="text" class="form-control" id="nama_rek"
                                       placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5 text-black">No. Rekening
                                Bank</label>
                            <div class="col-xl-6 col-lg-9 col-sm-10">
                                <input name="no.rek" value="" type="text" class="form-control" id="no_rek"
                                       placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
