                    ...
                    <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                        <form method="get" action="{{route('prodi.beasiswa.filter')}}">
                            ...
                            <select id="select-tahun-akademik" class="form-control-sm col-sm-6 float-right text-primary"
                                ...
                                <option value="">...</option>
                                <option {{request()->query('tahun_akademik') === '2022/2023 - Genap' ? 'selected' : ''}}>
                                    2022/2023 - Genap
                                </option>
                                <option {{request()->query('tahun_akademik') === '2022/2023 - Ganjil' ? 'selected' : ''}}>
                                    2022/2023 - Ganjil
                                </option>
                                <option {{request()->query('tahun_akademik') === '2021/2022 - Genap' ? 'selected' : ''}}>
                                    2021/2022 - Genap
                                </option>
                                <option {{request()->query('tahun_akademik') === '2021/2022 - Ganjil' ? 'selected' : ''}}>
                                    2021/2022 - Ganjil
                                </option>
                                <option {{request()->query('tahun_akademik') === '2020/2021 - Genap' ? 'selected' : ''}}>
                                    2020/2021 - Genap
                                </option>
                                <option {{request()->query('tahun_akademik') === '2020/2021 - Ganjil' ? 'selected' : ''}}>
                                    2020/2021 - Ganjil
                                </option>
                                <option {{request()->query('tahun_akademik') === '2019/2020 - Genap' ? 'selected' : ''}}>
                                    2019/2020 - Genap
                                </option>
                                <option {{request()->query('tahun_akademik') === '2019/2020 - Ganjil' ? 'selected' : ''}}>
                                    2019/2020 - Ganjil
                                </option>
                            </select>
