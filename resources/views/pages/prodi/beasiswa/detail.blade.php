                ...
                <form method="post" action="{{route('mahasiswas.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="nim" value="{{$beasiswa->mahasiswa->nim}}" type="text"
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="nama" value="{{$beasiswa->mahasiswa->nama}}" type="text"
                                   class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="program_study" value="{{$beasiswa->mahasiswa->prodi->program_study}}"
                                   type="text" class="form-control text-black" readonly id="program_study"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="angkatan" value="{{$beasiswa->mahasiswa->angkatan}}" type="text"
                                   class="form-control text-black" readonly id="program_study" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="jenis_kelamin" value="{{$beasiswa->jenis_kelamin}}" type="text"
                                   class="form-control text-black" readonly id="agama" placeholder="">
                        </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="agama" value="{{$beasiswa->agama}}" type="text" class="form-control text-black"
                                   readonly id="agama"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <textarea name="alamat" value="" type="text" class="form-control text-black" readonly id="alamat"
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="kode_pos" value="{{$beasiswa->kode_pos}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="ipk" value="{{$beasiswa->ipk}}" type="text" class="form-control text-black" readonly id="ipk"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="semester" value="{{$beasiswa->semester}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="email" value="{{$beasiswa->email}}" type="email" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="no_hp" value="{{$beasiswa->no_hp}}" type="number" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <div id="demo-test-gallery" class="demo-gallery" data-pswp-uid="1">
                                <a class="img-1" href="{{asset('uploads/foto/'.$beasiswa->foto)}}" data-size="1600x1068"
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="nama_ortu" value="{{$beasiswa->nama_ortu}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5">Alamat</label>
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <textarea name="alamat_ortu" value="" type="text" class="form-control text-black" readonly id="alamat_ortu"
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="pekerjaan_ortu" value="{{$beasiswa->pekerjaan_ortu}}" type="text"
                                   class="form-control text-black" readonly id="pekerjaan_ortu" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5">No. Hp Orangtua</label>
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="no_hp_ortu" value="{{$beasiswa->no_hp_ortu}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="no_hp_ortu" value="{{$beasiswa->penghasilan_ortu}}" type="text"
                                   class="form-control text-black" readonly id="no_hp_ortu" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="tanggungan_ortu" value="{{$beasiswa->tanggungan_ortu}}" type="text"
                                   class="form-control text-black" readonly id="tanggungan_ortu" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="nama_bank" value="{{$beasiswa->nama_bank}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="cabang_bank" value="{{$beasiswa->cabang_bank}}" type="text"
                                   class="form-control text-black" readonly id="cabang_bank" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-xl-2 col-sm-3 col-sm-2 col-form-label ml-5">Nama Pemegang Rekening</label>
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="nama_rek" value="{{$beasiswa->nama_rek}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-6 col-lg-9 col-sm-10">
                            <input name="no.rek" value="{{$beasiswa->no_rek}}" type="text" class="form-control text-black" readonly
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <button class="btn btn-primary px-5 float-right" type="button" onclick="history.back()">OK
                            </button>
                        </div>
                    </div>
                </form>
