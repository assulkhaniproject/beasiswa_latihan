            ...
            <div class="statbox widget box box-shadow">
                ...
                <form method="post" action="{{route('mahasiswa.store')}}">
                    ...
                    <div class="form-group row mr-lg-5">
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm ">Nomor Induk
                            Mahasiswa</label>
                        <div class="col-sm-8">
                            <input name="nim" type="number" value="{{old('nim')}}"
                                   class="form-control form-control-sm {{$errors->has('nim') ? 'is-invalid':''}}"
                    ...
                    <div class="form-group row mr-lg-5">
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm ">Nama
                            Lengkap</label>
                        <div class="col-sm-8">
                            <input name="nama" type="text" value="{{old('nama')}}"
                                   class="form-control form-control-sm {{$errors->has('nama') ? 'is-invalid':''}}"
                                   id="colFormLabelSm" placeholder="">
                            @if ($errors->has('nama'))
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row mr-lg-5">
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm ">Tempat
                            Lahir</label>
                        <div class="col-sm-8">
                            <input name="tempat_lahir" type="text" value="{{old('tempat_lahir')}}"
                                   class="form-control form-control-sm {{$errors->has('tempat_lahir') ? 'is-invalid':''}}"
                                   id="colFormLabelSm" placeholder="">
                    ...
                    <div class="form-group row mr-lg-5">
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm ">Tanggal
                            Lahir</label>
                        <div class="col-sm-8">
                            <input name="tanggal_lahir" type="date" value="{{old('tanggal_lahir')}}"
                                   class="form-control form-control-sm {{$errors->has('tanggal_lahir') ? 'is-invalid':''}}"
                                   id="colFormLabelSm" placeholder="">
                    ...
                    <div class="form-group row mr-lg-5">
                        ...
                        <div class="col-sm-8">
                            <textarea name="alamat" type=""
                                      class="form-control form-control-sm {{$errors->has('alamat') ? 'is-invalid':''}}"
                                      id="colFormLabelSm" placeholder="">{{old('alamat')}}</textarea>
                    ...
                    <div class="form-group row mr-lg-5">
                        ...
                        <div class="col-sm-8">
                            <select name="program_study" class="form-control form-small" required>
                                ...
                                @foreach($prodi as $p)
                                    <option value="{{$p->id}}" {{$p->id == old('program_study') ? 'selected' : ''}} >
                                        {{$p->program_study}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row mr-lg-5">
                        ...
                        <div class="col-sm-8">
                            <input name="angkatan" type="number" value="{{old('angkatan')}}"
                                   class="form-control form-control-sm {{$errors->has('angkatan') ? 'is-invalid':''}}"
                                   id="colFormLabelSm" placeholder="">
                    ...
                    <div class="form-group row mr-lg-5">
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm ">Jenis
                            Kelamin</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row mr-lg-5">
                        ...
                        <div class="col-sm-8">
                            <input name="no_hp" type="number" value="{{old('no_hp')}}"
                                   class="form-control form-control-sm {{$errors->has('no_hp') ? 'is-invalid':''}}"
                                   id="colFormLabelSm" placeholder="">
                            @if ($errors->has('no_hp'))
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row mr-lg-5">
                        <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm ">Nama Orang
                            Tua</label>
                        <div class="col-sm-8">
                            <input name="nama_ortu" type="text" value="{{old('nama_ortu')}}"
                                   class="form-control form-control-sm {{$errors->has('nama_ortu') ? 'is-invalid':''}}"
                                   id="colFormLabelSm" placeholder="">
