...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('page/images/logo.png')}}"/>
...
<section class="site-hero overlay" data-stellar-background-ratio="1"
         style="background-image: url({{asset('page/images/big_image_1.jpg')}});">
    <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
            <div class="col-md-12 text-center">
                <div class="mb-5 element-animate">
                    ...
                    <b><p class="lead">THE TRUE VOCATIONAL CAMPUS</p></b>
                    <b><a href="{{route('mahasiswa.show.login')}}" class="btn btn-outline-white  px-5 mt-3">L O G I N</a></b>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row top-course">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    ...
                    <h2 class="mt-3">Kementerian Riset dan Teknologi / Badan Riset dan Inovasi Nasional Republik
                        Indonesia</h2>
                    <p>Enroll Now</p>
                </a>
            </div>
...
<footer class="site-footer" style="background-image: url({{asset('page/images/big_image_3.jpg')}});">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-4">
                <h3>tentang</h3>
                <p>Aplikasi ini dibuat untuk menyelesaikan studi pada kampus Politeknik Harapan Bersama Kota Tegal
                    progam studi DIV Teknik Informatika.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    ...
                    Tugas Akhir | DIV Teknik Informatika
