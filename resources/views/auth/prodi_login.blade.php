...
<head>
    ...
    <title>BEASISWA PHB | Prodi Login </title>
    ...
    <link href="{{asset('prodi/assets/css/authentication/form-2.css')}}" rel="stylesheet" type="text/css" />
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <form class="text-left" method="POST" action="{{route('prodi.login')}}">
                        @csrf
                        <div class="form">

                            <a class="text-primary float-right h4">Admin Prodi Login</a>
...
<script src="{{asset('prodi/assets/js/authentication/form-2.js')}}"></script>
