                    ...
                    <div class="">
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="{{asset('prodi/assets/img/profile-16.jpg')}}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle" src="{{asset('prodi/assets/img/profile-34.jpg')}}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                    ...
                    <div class="">
                        ...
                        <div class="dropdown-item">
                           ...
                           document.getElementById('#').submit();">
                            ...
                            <form id="logout-prodi-form" action="#" method="POST" style="display: none;">
                                @csrf
                            </form>
                        </div>
                    </div>
