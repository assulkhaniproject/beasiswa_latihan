...
{{--                                <div class="media">--}}
{{--                                    <div class="user-img">--}}
{{--                                        <img class="usr-img rounded-circle" src="{{asset('prodi/assets/img/profile-11.jpg')}}" alt="profile">--}}
{{--                                    </div>--}}
...
{{--            </li>--}}
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                    ...
                    <img src="{{asset('uploads/admin prodi/'.Auth::guard('prodi')->user()->logo)}}" alt="avatar">
                </a>
...
{{--                        </div>--}}
                        <div class="dropdown-item">
                            <a class="" href="{{route('prodi.logout')}}" onclick="event.preventDefault();
                           document.getElementById('logout-prodi-form').submit();">
                            ...
                            <form id="logout-prodi-form" action="{{ route('prodi.logout') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                        </div>
                    </div>
